package com.example.timemanager.ui.dialog;
...
import com.example.timemanager.ui.adapter.CustomSpinnerAdapter;
import com.example.timemanager.R;
import com.example.timemanager.ui.main.MainActivity;
...
// 新增时间：2025年11月22日 03:05
    ...
    // 【2025-11-22 15:25】修复：弹窗主题与主界面同步
    // 功能作用：确保白天/黑夜模式下弹窗样式正确
    // 修改时间：2025年11月22日 15:25
    private boolean isNightMode() {
        if (getActivity() instanceof MainActivity) {
            return ((MainActivity) getActivity()).isNightMode();
        }
        // 回退到 SharedPreferences
        return requireActivity().getPreferences(Context.MODE_PRIVATE).getBoolean("isNight", false);
    }
